...
perlref - Perl referencias e estrutura de dados aninhadas

=head1 NOTE

Esta é a documentação completa sobre todos os aspectos das referencias. 
Para algo menor, como um tutorial de introdução sobre as principais 
características, veja L<perlreftut>.
